...
<body>
	...
	<div class="container">
		...
		<form method="post" action="<?= base_url(); ?>index.php/testController/loginCheck">
			...
			<br>
			<p><b>Don't have an Account? &nbsp SignUp Here &nbsp</b><a href="<?= base_url(); ?>index.php/testController/signupView"><button type="submit" name="signup" class="btn btn-primary">SIGNUP</button></a></p>
	</div>
</body>
</html>